...
/// TARS V2 token
contract TARSV2Token is ERC20("testart", "Tart"), Ownable {
    ...
    /// We need mint some TARS in advance
    uint256 public TARSInAdvance;
    ...
    /// @notice We need mint some TARSs in advance
    constructor() public {
        treasuryWalletAddr = _msgSender();
        TARSInAdvance = 500000 * 10**6 * 10**9;

        mint(treasuryWalletAddr, TARSInAdvance);
    }
    ...
    function transferTARSByOwner(address _to, uint256 _amount) external onlyOwner {
